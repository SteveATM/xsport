...
--ALTER TABLE llx_xsport_piste ADD UNIQUE INDEX uk_xsport_piste_fieldxy(fieldx, fieldy);

--ALTER TABLE llx_xsport_piste ADD CONSTRAINT llx_xsport_piste_fk_field FOREIGN KEY (fk_field) REFERENCES llx_xsport_myotherobject(rowid);
