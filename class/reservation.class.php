...
class Reservation extends CommonObject
{
	...
	public $fields=array(
		...
		'fk_piste' => array('type'=>'integer:Piste:xsport/class/piste.class.php:1:status=1', 'label'=>'Piste', 'enabled'=>'1', 'position'=>32, 'notnull'=>-1, 'visible'=>1, 'index'=>1, 'help'=>"test", 'comment'=> 'test2'),
		'fk_product' => array('type'=>'integer:Product:product/class/product.class.php:1:', 'label'=>'Eco Pass', 'enabled'=>'1', 'position'=>51, 'notnull'=>-1, 'visible'=>1, 'index'=>1, 'help'=>"LinkToThirparty",),
	...
	public function setDraft($user, $notrigger = 0)
	{
		...
		/*if (! ((empty($conf->global->MAIN_USE_ADVANCED_PERMS) && ! empty($user->rights->xsport->write))
		 || (! empty($conf->global->MAIN_USE_ADVANCED_PERMS) && ! empty($user->rights->xsport->xsport_advance->validate))))
		 {
	...
	public function getNextNumRef()
	{
		...
		if (!empty($conf->global->XSPORT_RESERVATION_ADDON))
		{
			...
			{
				$dir = dol_buildpath($reldir."core/modules/xsport/");
	...
	public function generateDocument($modele, $outputlangs, $hidedetails = 0, $hidedesc = 0, $hideref = 0, $moreparams = null)
	{
		...
		$modelpath = "core/modules/xsport/doc/";
