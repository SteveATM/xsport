...
/**
 * \file    test/phpunit/XsportFunctionalTest.php
 * \ingroup xsport
 ...
 * @package Testxsport
 */
class XsportFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/xsport/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('xsport/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/xsport/admin/about.php');
		$this->authenticate();
		return $this->assertContains('xsport/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('xsportwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modXsport_XsportTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modXsport_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
